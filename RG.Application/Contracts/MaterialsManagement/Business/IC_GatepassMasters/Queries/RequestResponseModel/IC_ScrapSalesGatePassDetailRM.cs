...
{
    public class IC_ScrapSalesGatePassDetailRM : IMapFrom<IC_ScrapSalesGatePassDetail>
    {
        ...
        {
            profile.CreateMap<IC_ScrapSalesGatePassDetailRM, IC_ScrapSalesGatePassDetail>().ReverseMap();
        }
    }
}
