...
{
    public interface IAccountsReportsService
    {
    ...
    int SelectWithDetail, int ReportGroup, int VoucherPosted, DateTime DateFrom, DateTime DateTo, int IsExcludeZeroBalance, int NoteGroupID);
        ...
        Task<List<VoucherShortInfoTBRM>> GetVoucherShortInfoTB(int accountID, DateTime dateFrom, DateTime dateTo, bool needConversion=false, CancellationToken cancellationToken=default);
