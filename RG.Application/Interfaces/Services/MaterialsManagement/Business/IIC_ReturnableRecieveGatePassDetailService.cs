...
{
    public interface IIC_ReturnableRecieveGatePassDetailService
    {
        Task<RResult> SaveReturnableRecieveGatePassDetail(List<IC_ReturnableRecieveGatePassDetailDTM> model, CancellationToken cancellationToken);
    }
}
