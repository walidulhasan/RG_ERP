...
namespace RG.Application.ViewModel.AlgoHR.Business.PayrollReports
{
    public class MonthWiseGeneratePayrolVM
    {
        ...
        public int ShiftAssignedID { get; set; }
        ...
        public List<SelectListItem> DDLShiftAssige  { get; set; }
